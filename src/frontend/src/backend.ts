...
export class Backend implements backendInterface {
    ...
    async createClub(arg0: Club): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createClub(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getClubBySlug(arg0: string): Promise<Club | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getClubBySlug(arg0);
    ...
    async getGeneralStock(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGeneralStock();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProductsByClub(arg0: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsByClub(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateClub(arg0: Club): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateClub(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Club]): Club | null {
    return value.length === 0 ? null : value[0];
}
